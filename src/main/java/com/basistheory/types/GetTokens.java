...
@JsonDeserialize(builder = GetTokens.Builder.class)
public final class GetTokens {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetTokens && equalTo((GetTokens) other);
    }
    ...
    private boolean equalTo(GetTokens other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetTokens other) {
            id(other.getId());
        ...
        public GetTokens build() {
            return new GetTokens(id, metadata, page, start, size, additionalProperties);
        }
    }
}
