...
@JsonDeserialize(builder = GetProxies.Builder.class)
public final class GetProxies {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetProxies && equalTo((GetProxies) other);
    }
    ...
    private boolean equalTo(GetProxies other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetProxies other) {
            id(other.getId());
            name(other.getName());
            page(other.getPage());
        ...
        public GetProxies build() {
            return new GetProxies(id, name, page, start, size, additionalProperties);
        }
    }
}
