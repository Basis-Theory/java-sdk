...
@JsonDeserialize(builder = CredentialsCard.Builder.class)
public final class CredentialsCard {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CredentialsCard && equalTo((CredentialsCard) other);
    }
    ...
    private boolean equalTo(CredentialsCard other) {
    ...
    public static final class Builder {
        ...
        public Builder from(CredentialsCard other) {
        ...
        public CredentialsCard build() {
            return new CredentialsCard(number, expirationMonth, expirationYear, cvc, additionalProperties);
        }
    }
}
