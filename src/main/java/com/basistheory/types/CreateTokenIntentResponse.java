...
@JsonDeserialize(builder = CreateTokenIntentResponse.Builder.class)
public final class CreateTokenIntentResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateTokenIntentResponse && equalTo((CreateTokenIntentResponse) other);
    }
    ...
    private boolean equalTo(CreateTokenIntentResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(CreateTokenIntentResponse other) {
            id(other.getId());
            type(other.getType());
