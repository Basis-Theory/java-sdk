...
@JsonDeserialize(builder = SharedPaymentCardIssuerCountry.Builder.class)
public final class SharedPaymentCardIssuerCountry {
    ...
    private SharedPaymentCardIssuerCountry(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SharedPaymentCardIssuerCountry && equalTo((SharedPaymentCardIssuerCountry) other);
    }
    ...
    private boolean equalTo(SharedPaymentCardIssuerCountry other) {
    ...
    public static final class Builder {
        ...
        public Builder from(SharedPaymentCardIssuerCountry other) {
        ...
        public SharedPaymentCardIssuerCountry build() {
            return new SharedPaymentCardIssuerCountry(alpha2, name, numeric, additionalProperties);
        }
