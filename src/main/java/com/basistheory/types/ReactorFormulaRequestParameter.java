...
@JsonDeserialize(builder = ReactorFormulaRequestParameter.Builder.class)
public final class ReactorFormulaRequestParameter {
    ...
    private ReactorFormulaRequestParameter(
            String name,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ReactorFormulaRequestParameter && equalTo((ReactorFormulaRequestParameter) other);
    }
    ...
    private boolean equalTo(ReactorFormulaRequestParameter other) {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.name, this.description, this.type, this.optional);
    }
    ...
    public interface NameStage {
        ...
        Builder from(ReactorFormulaRequestParameter other);
    }
    ...
    public interface _FinalStage {
        ReactorFormulaRequestParameter build();
    ...
    public static final class Builder implements NameStage, TypeStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ReactorFormulaRequestParameter other) {
            name(other.getName());
        ...
        @java.lang.Override
        public ReactorFormulaRequestParameter build() {
            return new ReactorFormulaRequestParameter(name, description, type, optional, additionalProperties);
        }
    }
}
