...
@JsonDeserialize(builder = AgenticCardIssuerCountry.Builder.class)
public final class AgenticCardIssuerCountry {
    ...
    private AgenticCardIssuerCountry(
    ...
    /**
     * @return ISO 3166-1 numeric country code
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AgenticCardIssuerCountry && equalTo((AgenticCardIssuerCountry) other);
    }
    ...
    private boolean equalTo(AgenticCardIssuerCountry other) {
    ...
    public static final class Builder {
        ...
        public Builder from(AgenticCardIssuerCountry other) {
        ...
        /**
         * <p>ISO 3166-1 numeric country code</p>
         */
        ...
        public AgenticCardIssuerCountry build() {
            return new AgenticCardIssuerCountry(alpha2, name, numeric, additionalProperties);
        }
    }
}
