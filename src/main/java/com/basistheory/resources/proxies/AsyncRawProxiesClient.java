...
public class AsyncRawProxiesClient {
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new BasisTheoryApiHttpResponse<>(
                                new SyncPagingIterable<Proxy>(true, result, parsedResponse, () -> {
                                    try {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<Void>> transferHostname(
            String id, TransferProxyHostnameRequest request) {
