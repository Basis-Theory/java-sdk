...
public class AsyncProxiesClient {
    ...
    public CompletableFuture<SyncPagingIterable<Proxy>> list(
        ...
        CompletableFuture<SyncPagingIterable<Proxy>> future = new CompletableFuture<>();
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new SyncPagingIterable<Proxy>(true, result, () -> {
                            try {
    ...
    public CompletableFuture<Proxy> create(CreateProxyRequest request, IdempotentRequestOptions requestOptions) {
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), Proxy.class));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    try {
