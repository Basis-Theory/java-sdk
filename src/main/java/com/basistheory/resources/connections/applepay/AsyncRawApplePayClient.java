...
public class AsyncRawApplePayClient {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<ApplePayTokenizeResponse>> tokenize() {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<ApplePayTokenizeResponse>> tokenize(
        ...
        CompletableFuture<BasisTheoryApiHttpResponse<ApplePayTokenizeResponse>> future = new CompletableFuture<>();
