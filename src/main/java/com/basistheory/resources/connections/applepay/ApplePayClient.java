 ...
 */
package com.basistheory.resources.connections.applepay;
...
import com.basistheory.resources.connections.applepay.domain.DomainClient;
import com.basistheory.resources.connections.applepay.requests.ApplePayTokenizeRequest;
import com.basistheory.resources.connections.applepay.session.SessionClient;
    ...
    public ApplePayTokenizeResponse tokenize(ApplePayTokenizeRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), ApplePayTokenizeResponse.class);
            }
