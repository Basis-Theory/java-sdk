...
public class AsyncRawRolesClient {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<List<Role>>> list() {
        return list(null);
    }

    public CompletableFuture<BasisTheoryApiHttpResponse<List<Role>>> list(RequestOptions requestOptions) {
        ...
        CompletableFuture<BasisTheoryApiHttpResponse<List<Role>>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new BasisTheoryApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), new TypeReference<List<Role>>() {}),
                                response));
                        return;
                    }
