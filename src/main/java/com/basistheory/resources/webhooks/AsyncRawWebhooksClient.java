...
public class AsyncRawWebhooksClient {
     ...
     * Returns the webhook
     */
    public CompletableFuture<BasisTheoryApiHttpResponse<Webhook>> get(String id) {
        return get(id, null);
    }
     ...
     * Returns the webhook
     */
    public CompletableFuture<BasisTheoryApiHttpResponse<Webhook>> get(String id, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
        ...
        CompletableFuture<BasisTheoryApiHttpResponse<Webhook>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<BasisTheoryApiHttpResponse<Webhook>> update(String id, UpdateWebhookRequest request) {
     ...
     * Update a new webhook
     */
    public CompletableFuture<BasisTheoryApiHttpResponse<Webhook>> update(
     ...
     */
    public CompletableFuture<BasisTheoryApiHttpResponse<WebhookList>> list() {
        return list(null);
    }
     ...
     * Returns the configured webhooks
     */
    public CompletableFuture<BasisTheoryApiHttpResponse<WebhookList>> list(RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("webhooks");
        if (requestOptions != null) {
        ...
        CompletableFuture<BasisTheoryApiHttpResponse<WebhookList>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new BasisTheoryApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, WebhookList.class), response));
                        return;
                    }
                    try {
                        switch (response.code()) {
     ...
     */
    public CompletableFuture<BasisTheoryApiHttpResponse<Webhook>> create(CreateWebhookRequest request) {
     ...
     * Create a new webhook
     */
    public CompletableFuture<BasisTheoryApiHttpResponse<Webhook>> create(
