...
public class RawDocumentClient {
    protected final ClientOptions clientOptions;

    public RawDocumentClient(ClientOptions clientOptions) {
    ...
    public BasisTheoryApiHttpResponse<Document> upload(Optional<File> document, DocumentUploadRequest request) {
