...
public class AsyncRawPermissionsClient {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<List<Permission>>> list() {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<List<Permission>>> list(
        ...
        CompletableFuture<BasisTheoryApiHttpResponse<List<Permission>>> future = new CompletableFuture<>();
