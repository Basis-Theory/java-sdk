...
public class AsyncRawCertificatesClient {
    protected final ClientOptions clientOptions;

    public AsyncRawCertificatesClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<BasisTheoryApiHttpResponse<ApplePayMerchantCertificates>> get(
            String merchantId, String id) {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<ApplePayMerchantCertificates>> get(
        ...
        CompletableFuture<BasisTheoryApiHttpResponse<ApplePayMerchantCertificates>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new BasisTheoryApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, ApplePayMerchantCertificates.class),
                                response));
                        return;
                    }
                    try {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<Void>> delete(String merchantId, String id) {
