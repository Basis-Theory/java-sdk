...
public class AsyncRawMerchantClient {
    protected final ClientOptions clientOptions;

    public AsyncRawMerchantClient(ClientOptions clientOptions) {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<ApplePayMerchant>> create() {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<ApplePayMerchant>> create(
        ...
        CompletableFuture<BasisTheoryApiHttpResponse<ApplePayMerchant>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new BasisTheoryApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), ApplePayMerchant.class),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
