...
public class AsyncRawMerchantClient {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<ApplePayMerchant>> get(String id) {
        return get(id, null);
    }

    public CompletableFuture<BasisTheoryApiHttpResponse<ApplePayMerchant>> get(
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new BasisTheoryApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ApplePayMerchant.class),
                                response));
                        return;
                    }
                    try {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<ApplePayMerchant>> create(RequestOptions requestOptions) {
