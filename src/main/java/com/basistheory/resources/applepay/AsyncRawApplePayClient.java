...
public class AsyncRawApplePayClient {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<ApplePayCreateResponse>> create(RequestOptions requestOptions) {
        return create(ApplePayCreateRequest.builder().build(), requestOptions);
    }
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new BasisTheoryApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ApplePayCreateResponse.class),
                                response));
                        return;
                    }
                    try {
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new BasisTheoryApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ApplePayToken.class),
                                response));
                        return;
                    }
                    try {
