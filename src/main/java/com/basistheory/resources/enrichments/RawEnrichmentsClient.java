...
public class RawEnrichmentsClient {
    protected final ClientOptions clientOptions;

    public RawEnrichmentsClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public BasisTheoryApiHttpResponse<BankVerificationResponse> bankAccountVerify(BankVerificationRequest request) {
