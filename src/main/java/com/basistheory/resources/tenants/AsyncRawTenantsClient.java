...
public class AsyncRawTenantsClient {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<SecurityContactEmailResponse>> getsecuritycontact() {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<SecurityContactEmailResponse>> updatesecuritycontact(
