...
public class RawTenantsClient {
    ...
    public BasisTheoryApiHttpResponse<SecurityContactEmailResponse> getsecuritycontact() {
        return getsecuritycontact(null);
    }

    public BasisTheoryApiHttpResponse<SecurityContactEmailResponse> getsecuritycontact(RequestOptions requestOptions) {
    ...
    public BasisTheoryApiHttpResponse<SecurityContactEmailResponse> updatesecuritycontact(
            SecurityContactEmailRequest request) {
        return updatesecuritycontact(request, null);
    }
