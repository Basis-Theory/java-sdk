...
public class RawTenantsClient {
    ...
    public BasisTheoryApiHttpResponse<TenantMemberResponse> ownerTransfer(TransferTenantOwnerRequest request) {
        return ownerTransfer(request, null);
    }

    public BasisTheoryApiHttpResponse<TenantMemberResponse> ownerTransfer(
