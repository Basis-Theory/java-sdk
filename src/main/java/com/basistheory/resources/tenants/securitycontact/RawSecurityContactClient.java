...
public class RawSecurityContactClient {
    protected final ClientOptions clientOptions;

    public RawSecurityContactClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public BasisTheoryApiHttpResponse<SecurityContactEmailResponse> get() {
        return get(null);
    }

    public BasisTheoryApiHttpResponse<SecurityContactEmailResponse> get(RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("tenants/self/security-contact")
                .build();
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new BasisTheoryApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), SecurityContactEmailResponse.class),
                        response);
            }
    ...
    public BasisTheoryApiHttpResponse<SecurityContactEmailResponse> update(SecurityContactEmailRequest request) {
        return update(request, null);
    }

    public BasisTheoryApiHttpResponse<SecurityContactEmailResponse> update(
