...
public class AsyncRawSecurityContactClient {
    protected final ClientOptions clientOptions;

    public AsyncRawSecurityContactClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<BasisTheoryApiHttpResponse<SecurityContactEmailResponse>> get() {
        return get(null);
    }
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<SecurityContactEmailResponse>> get(
        ...
        CompletableFuture<BasisTheoryApiHttpResponse<SecurityContactEmailResponse>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new BasisTheoryApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), SecurityContactEmailResponse.class),
                                response));
                        return;
                    }
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<SecurityContactEmailResponse>> update(
