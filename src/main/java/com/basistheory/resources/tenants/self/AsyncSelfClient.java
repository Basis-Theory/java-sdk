...
public class AsyncSelfClient {
    ...
    public CompletableFuture<TenantUsageReport> getUsageReports(RequestOptions requestOptions) {
        ...
        CompletableFuture<TenantUsageReport> future = new CompletableFuture<>();
    ...
    public CompletableFuture<Tenant> get(RequestOptions requestOptions) {
        ...
        CompletableFuture<Tenant> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), Tenant.class));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    try {
