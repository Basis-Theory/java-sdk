...
public class RawOwnerClient {
    ...
    public BasisTheoryApiHttpResponse<TenantMemberResponse> transfer(TransferTenantOwnerRequest request) {
        return transfer(request, null);
    }

    public BasisTheoryApiHttpResponse<TenantMemberResponse> transfer(
