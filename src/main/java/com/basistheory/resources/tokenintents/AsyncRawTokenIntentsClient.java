...
public class AsyncRawTokenIntentsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawTokenIntentsClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<BasisTheoryApiHttpResponse<TokenIntent>> get(String id) {
        return get(id, null);
    }

    public CompletableFuture<BasisTheoryApiHttpResponse<TokenIntent>> get(String id, RequestOptions requestOptions) {
        ...
        CompletableFuture<BasisTheoryApiHttpResponse<TokenIntent>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new BasisTheoryApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, TokenIntent.class), response));
                        return;
                    }
                    try {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<CreateTokenIntentResponse>> create(
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<CreateTokenIntentResponse>> create(
        ...
        CompletableFuture<BasisTheoryApiHttpResponse<CreateTokenIntentResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new BasisTheoryApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, CreateTokenIntentResponse.class),
                                response));
                        return;
                    }
                    try {
