...
public class AsyncTokenIntentsClient {
    ...
    public CompletableFuture<TokenIntent> get(String id, RequestOptions requestOptions) {
        ...
        CompletableFuture<TokenIntent> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), TokenIntent.class));
                        return;
                    }
    ...
    public CompletableFuture<CreateTokenIntentResponse> create(
        ...
        CompletableFuture<CreateTokenIntentResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
