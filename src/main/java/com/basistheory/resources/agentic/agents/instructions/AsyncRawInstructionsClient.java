...
public class AsyncRawInstructionsClient {
     ...
     */
    public CompletableFuture<BasisTheoryApiHttpResponse<InstructionList>> list(String agentId) {
     ...
     * List all purchase instructions for an agent with cursor-based pagination and optional enrollment filter.
     */
    public CompletableFuture<BasisTheoryApiHttpResponse<InstructionList>> list(
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<InstructionList>> list(
        ...
        CompletableFuture<BasisTheoryApiHttpResponse<InstructionList>> future = new CompletableFuture<>();
