...
public class RawInstructionsClient {
    protected final ClientOptions clientOptions;

    public RawInstructionsClient(ClientOptions clientOptions) {
     ...
     */
    public BasisTheoryApiHttpResponse<SyncPagingIterable<Instruction>> list(String agentId) {
     ...
     */
    public BasisTheoryApiHttpResponse<Instruction> create(String agentId, CreateInstructionRequest request) {
    ...
    public BasisTheoryApiHttpResponse<Instruction> get(String agentId, String instructionId) {
    ...
    public BasisTheoryApiHttpResponse<Void> delete(String agentId, String instructionId) {
    ...
    public BasisTheoryApiHttpResponse<Instruction> update(String agentId, String instructionId) {
     ...
     */
    public BasisTheoryApiHttpResponse<PublishConfirmationResponse> confirmations(
            String agentId, String instructionId, PublishConfirmationRequest request) {
        return confirmations(agentId, instructionId, request, null);
    }
    ...
    public BasisTheoryApiHttpResponse<PublishConfirmationResponse> confirmations(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new BasisTheoryApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PublishConfirmationResponse.class),
                        response);
            }
            try {
                switch (response.code()) {
