...
public class RawInstructionsClient {
     ...
     */
    public BasisTheoryApiHttpResponse<InstructionList> list(String agentId) {
     ...
     * List all purchase instructions for an agent with cursor-based pagination and optional enrollment filter.
     */
    public BasisTheoryApiHttpResponse<InstructionList> list(String agentId, InstructionsListRequest request) {
     ...
     * List all purchase instructions for an agent with cursor-based pagination and optional enrollment filter.
     */
    public BasisTheoryApiHttpResponse<InstructionList> list(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new BasisTheoryApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), InstructionList.class), response);
            }
