...
public class AsyncRawGooglePayClient {
    protected final ClientOptions clientOptions;

    public AsyncRawGooglePayClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<BasisTheoryApiHttpResponse<GooglePayCreateResponse>> create() {
        return create(GooglePayCreateRequest.builder().build());
    }

    public CompletableFuture<BasisTheoryApiHttpResponse<GooglePayCreateResponse>> create(
            RequestOptions requestOptions) {
        return create(GooglePayCreateRequest.builder().build(), requestOptions);
    }
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<GooglePayCreateResponse>> create(
        ...
        CompletableFuture<BasisTheoryApiHttpResponse<GooglePayCreateResponse>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new BasisTheoryApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GooglePayCreateResponse.class),
                                response));
                        return;
                    }
                    try {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<GooglePayToken>> get(String id) {
        return get(id, null);
    }

    public CompletableFuture<BasisTheoryApiHttpResponse<GooglePayToken>> get(String id, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("google-pay")
                .addPathSegment(id);
        ...
        CompletableFuture<BasisTheoryApiHttpResponse<GooglePayToken>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new BasisTheoryApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GooglePayToken.class),
                                response));
                        return;
                    }
                    try {
