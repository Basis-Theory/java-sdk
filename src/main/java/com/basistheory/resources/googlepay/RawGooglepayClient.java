...
public class RawGooglepayClient {
    ...
    public BasisTheoryApiHttpResponse<GooglePayTokenizeResponse> tokenize() {
        return tokenize(GooglePayTokenizeRequest.builder().build());
    }

    public BasisTheoryApiHttpResponse<GooglePayTokenizeResponse> tokenize(GooglePayTokenizeRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new BasisTheoryApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), GooglePayTokenizeResponse.class),
                        response);
            }
