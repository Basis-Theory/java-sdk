...
public class AsyncRawGooglepayClient {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<GooglePayTokenizeResponse>> tokenize() {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<GooglePayTokenizeResponse>> tokenize(
        ...
        CompletableFuture<BasisTheoryApiHttpResponse<GooglePayTokenizeResponse>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new BasisTheoryApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), GooglePayTokenizeResponse.class),
                                response));
                        return;
                    }
