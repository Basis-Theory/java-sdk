...
public class AsyncSessionsClient {
    ...
    public CompletableFuture<CreateThreeDsSessionResponse> create(
        ...
        CompletableFuture<CreateThreeDsSessionResponse> future = new CompletableFuture<>();
    ...
    public CompletableFuture<ThreeDsAuthentication> authenticate(
        ...
        CompletableFuture<ThreeDsAuthentication> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(ObjectMappers.JSON_MAPPER.readValue(
                                responseBody.string(), ThreeDsAuthentication.class));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    try {
    ...
    public CompletableFuture<ThreeDsSession> get(String id, RequestOptions requestOptions) {
        ...
        CompletableFuture<ThreeDsSession> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
