...
public class RawDataClient {
    ...
    public BasisTheoryApiHttpResponse<Void> get(String documentId) {
        return get(documentId, null);
    }

    public BasisTheoryApiHttpResponse<Void> get(String documentId, RequestOptions requestOptions) {
