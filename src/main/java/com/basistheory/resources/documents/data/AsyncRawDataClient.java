...
public class AsyncRawDataClient {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<Void>> get(String documentId) {
        return get(documentId, null);
    }

    public CompletableFuture<BasisTheoryApiHttpResponse<Void>> get(String documentId, RequestOptions requestOptions) {
