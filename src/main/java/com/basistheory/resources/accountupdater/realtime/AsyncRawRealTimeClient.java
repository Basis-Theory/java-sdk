...
public class AsyncRawRealTimeClient {
     ...
     */
    public CompletableFuture<BasisTheoryApiHttpResponse<AccountUpdaterRealTimeResponse>> invoke(
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<AccountUpdaterRealTimeResponse>> invoke(
        ...
        CompletableFuture<BasisTheoryApiHttpResponse<AccountUpdaterRealTimeResponse>> future =
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new BasisTheoryApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, AccountUpdaterRealTimeResponse.class),
                                response));
                        return;
                    }
                    try {
