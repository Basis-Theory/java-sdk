...
public class RawRealTimeClient {
     ...
     */
    public BasisTheoryApiHttpResponse<AccountUpdaterRealTimeResponse> invoke(AccountUpdaterRealTimeRequest request) {
     ...
     * Returns the update result
     */
    public BasisTheoryApiHttpResponse<AccountUpdaterRealTimeResponse> invoke(
            AccountUpdaterRealTimeRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("account-updater/real-time");
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new BasisTheoryApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AccountUpdaterRealTimeResponse.class),
                        response);
            }
            try {
