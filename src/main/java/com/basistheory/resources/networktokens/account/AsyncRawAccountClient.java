...
public class AsyncRawAccountClient {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<NetworkTokenAccount>> get(String id) {
        return get(id, null);
    }

    public CompletableFuture<BasisTheoryApiHttpResponse<NetworkTokenAccount>> get(
        ...
        CompletableFuture<BasisTheoryApiHttpResponse<NetworkTokenAccount>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new BasisTheoryApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), NetworkTokenAccount.class),
                                response));
                        return;
                    }
