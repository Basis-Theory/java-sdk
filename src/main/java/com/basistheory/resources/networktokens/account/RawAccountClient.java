...
public class RawAccountClient {
    ...
    public BasisTheoryApiHttpResponse<NetworkTokenAccount> get(String id) {
        return get(id, null);
    }

    public BasisTheoryApiHttpResponse<NetworkTokenAccount> get(String id, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new BasisTheoryApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, NetworkTokenAccount.class), response);
            }
            try {
