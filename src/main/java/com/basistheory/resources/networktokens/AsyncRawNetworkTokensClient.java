...
public class AsyncRawNetworkTokensClient {
    ...
    public CompletableFuture<BasisTheoryApiHttpResponse<Token>> tokenize() {
        return tokenize(CreateNetworkTokenRequest.builder().build());
    }

    public CompletableFuture<BasisTheoryApiHttpResponse<Token>> tokenize(CreateNetworkTokenRequest request) {
