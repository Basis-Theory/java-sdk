...
public class TokensClient {
    ...
    public TokenPaginatedList list() {
        return list(TokensListRequest.builder().build());
    }

    public TokenPaginatedList list(TokensListRequest request) {
        return list(request, null);
    }

    public TokenPaginatedList list(TokensListRequest request, RequestOptions requestOptions) {
    ...
    public TokenCursorPaginatedList listV2() {
        return listV2(TokensListV2Request.builder().build());
    }

    public TokenCursorPaginatedList listV2(TokensListV2Request request) {
        return listV2(request, null);
    }

    public TokenCursorPaginatedList listV2(TokensListV2Request request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
