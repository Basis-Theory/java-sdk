...
public final class ProxiesListRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ProxiesListRequest && equalTo((ProxiesListRequest) other);
    }
    ...
    private boolean equalTo(ProxiesListRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ProxiesListRequest other) {
            id(other.getId());
            name(other.getName());
            page(other.getPage());
