 ...
 */
package com.basis.theory.api.resources.sessions;
...
import com.basis.theory.api.resources.sessions.requests.AuthorizeSessionRequest;
import com.basis.theory.api.types.CreateSessionResponse;
    ...
    public CreateSessionResponse create(IdempotentRequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), CreateSessionResponse.class);
            }
