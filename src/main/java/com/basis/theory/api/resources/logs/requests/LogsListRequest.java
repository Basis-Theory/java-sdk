 ...
 */
package com.basis.theory.api.resources.logs.requests;
...
@JsonDeserialize(builder = LogsListRequest.Builder.class)
public final class LogsListRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LogsListRequest && equalTo((LogsListRequest) other);
    }
    ...
    private boolean equalTo(LogsListRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(LogsListRequest other) {
